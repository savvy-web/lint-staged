...
* [`a4f4c35`](https://github.com/savvy-web/lint-staged/commit/a4f4c355b079c282cbe7eb735435302976ce1adc) ### Package Deprecation
...
* | [`532e573`](https://github.com/savvy-web/lint-staged/commit/532e573af3d196befaaec23212cb749ca5799dc8) | Dependency     | Type    | Action                | From                  | To |
  | :---------------------------------------------------------------------------------------------------- | :------------- | :------ | :-------------------- | :-------------------- | -- |
  | turbo                                                                                                 | peerDependency | updated | ^2.9.15               | ^2.9.16               |    |
  | @typescript/native-preview                                                                            | devDependency  | updated | ^7.0.0-dev.20260523.1 | ^7.0.0-dev.20260527.2 |    |
  | @savvy-web/rslib-builder                                                                              | devDependency  | updated | ^0.20.8               | ^0.20.9               |    |
  | turbo                                                                                                 | devDependency  | updated | ^2.9.15               | ^2.9.16               |    |

## 1.2.0

### Features

* [`0429b0e`](https://github.com/savvy-web/lint-staged/commit/0429b0eff606300f0a7420b62393d69253e9d2b8) `savvy-lint init` now writes `.husky/pre-commit` as two ordered managed
...
* [`0429b0e`](https://github.com/savvy-web/lint-staged/commit/0429b0eff606300f0a7420b62393d69253e9d2b8) `savvy-lint init` now removes the legacy `SAVVY-LINT` hygiene block from
...
* | [`0429b0e`](https://github.com/savvy-web/lint-staged/commit/0429b0eff606300f0a7420b62393d69253e9d2b8) | Dependency     | Type    | Action  | From    | To |
  | :---------------------------------------------------------------------------------------------------- | :------------- | :------ | :------ | :------ | -- |
  | @savvy-web/silk-effects                                                                               | dependency     | updated | ^0.4.1  | ^0.5.0  |    |
  | @savvy-web/rslib-builder                                                                              | devDependency  | updated | ^0.20.7 | ^0.20.8 |    |
  | turbo                                                                                                 | devDependency  | updated | ^2.9.14 | ^2.9.15 |    |
  | @biomejs/biome                                                                                        | peerDependency | updated | 2.4.15  | 2.4.16  |    |
  | turbo                                                                                                 | peerDependency | updated | ^2.9.14 | ^2.9.15 |    |
...
* [`cefc0e1`](https://github.com/savvy-web/lint-staged/commit/cefc0e12f4782f228a05cb5a0d6c9b9b53869977) New `Workspace` utility module exported from the package root. Provides synchronous, cached access to workspace layout via `workspaces-effect`:
...
* | [`cefc0e1`](https://github.com/savvy-web/lint-staged/commit/cefc0e12f4782f228a05cb5a0d6c9b9b53869977) | Dependency    | Type    | Action  | From    | To |
  | :---------------------------------------------------------------------------------------------------- | :------------ | :------ | :------ | :------ | -- |
...
* [`a7e608e`](https://github.com/savvy-web/lint-staged/commit/a7e608e5b5a546ebcf584c4ae45e986615b2e456) ### Removed `ConfigSearch` utility
...
* [`a7e608e`](https://github.com/savvy-web/lint-staged/commit/a7e608e5b5a546ebcf584c4ae45e986615b2e456) ### Claude Code companion plugin
...
* [`a7e608e`](https://github.com/savvy-web/lint-staged/commit/a7e608e5b5a546ebcf584c4ae45e986615b2e456) ### Adopted `@savvy-web/silk-effects` for shared logic
...
* | [`a7e608e`](https://github.com/savvy-web/lint-staged/commit/a7e608e5b5a546ebcf584c4ae45e986615b2e456) | Dependency | Type    | Action | From   | To |
  | ----------------------------------------------------------------------------------------------------- | ---------- | ------- | ------ | ------ | -- |
...
* | [`1e6ca97`](https://github.com/savvy-web/lint-staged/commit/1e6ca9712cf5fd7fc12aa07023d6e6ac1076f43f) | Dependency    | Type    | Action | From   | To |
  | :---------------------------------------------------------------------------------------------------- | :------------ | :------ | :----- | :----- | -- |
...
* | [`cb8a5e6`](https://github.com/savvy-web/lint-staged/commit/cb8a5e69b5b97da87973abecdee2fb35ea6328f1) | Dependency | Type    | Action  | From    | To |
  | :---------------------------------------------------------------------------------------------------- | :--------- | :------ | :------ | :------ | -- |
