...
Validates design documentation structure and updates timestamps.

**Glob:** `.claude/design/**/*.md`

**Default Excludes:** `['design.config.json']`
...
| `validateScript` | `string` | `.claude/skills/.../validate-design-doc.sh` | Validation script |
| `timestampScript` | `string` | `.claude/skills/.../update-timestamp.sh` | Timestamp script |
